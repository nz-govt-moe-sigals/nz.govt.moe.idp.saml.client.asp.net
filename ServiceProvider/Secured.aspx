<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Secured.aspx.cs" Inherits="WebsiteDemo.Secured" MasterPageFile="~/sp.Master"%>

<%@ Import Namespace="nz.govt.moe.idp.saml.client.identity" %>
<%@ Import Namespace="nz.govt.moe.idp.saml.client.config" %>
<%@ Import Namespace="nz.govt.moe.idp.saml.client.Schema.Core" %>
